...
public final class FragmentSettingsBinding implements ViewBinding {
  ...
  private FragmentSettingsBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout btnBackup,
      @NonNull LinearLayout btnLanguage, @NonNull LinearLayout btnProfile) {
  ...
  public static FragmentSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSettingsBinding((LinearLayout) rootView, btnBackup, btnLanguage,
          btnProfile);
    }
